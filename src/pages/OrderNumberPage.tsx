...
const OrderNumberPage: React.FC = () => {
  ...
  if (!orderInfo) {
    return (
      <div className="numberBody min-h-screen bg-[#faf9f7] flex flex-col items-center justify-center p-4">
  ...
  return (
    <div className="numberBody min-h-screen bg-[#faf9f7] font-sans pb-32">
